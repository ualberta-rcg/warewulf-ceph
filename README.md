<img src="https://upload.wikimedia.org/wikipedia/commons/6/65/Ceph_logo.svg" alt="Ceph Logo" width="50%" />
...
This project is provided as-is, but reasonable questions may be answered based on coffee intake and cluster load.
...
We design and operate compute and storage environments that power innovation — from AI training clusters to national research storage infrastructure.
